package com.bcebhagalpur.cheashu.dashboard.model

class ExploreItemListModel {
    ...
    val images      : java.util.ArrayList<String>?=null
    val tags        : java.util.ArrayList<String>?=null
