...
import com.bcebhagalpur.cheashu.dashboard.chat.activity.ChatActivity
...
class MyFirebaseMessaging:FirebaseMessagingService()
{
    ...
    override fun onMessageReceived(mRemoteMessage: RemoteMessage) {
        ...
        val sheredPredf=getSharedPreferences("PREFS", Context.MODE_PRIVATE)
        val currentOnlineUser=sheredPredf.getString("currentuser","none")
